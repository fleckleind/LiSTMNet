...
args = EasyDict(base_lr=0.0005,
            ...
            keep_log=False,
            low_image_size=256,
            modelname='ResNet18_FSTMamba_FFM',
            n_gpu=1,
            ...
            point_numbers=1,
            reinforce=True,
            compute_ef=False,# )  # echonet-dynamic deny ef computation
            n_skip=3,
            vit_patches_size=16)
...
opt.load_path = ''  # !!! checkpoints original path not relative path !!!
...
opt.modelname = 'ResNet18_FSTMamba_BSTAFusion'
...
input = torch.randn(1, 10, 3, args.encoder_input_size, args.encoder_input_size).cuda()
